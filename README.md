...
Como Staff Engineer, diseñé este pipeline para que cada agente sea un especialista modular, compuesto por skills técnicas reutilizables. Debajo detallo los 8 steps del pipeline, con sus skills subyacentes que ejecutan la lógica de bajo nivel.

Al inicializar el proyecto, los siguientes agentes estarán disponibles en tu IDE para ser invocados mediante comandos de chats
